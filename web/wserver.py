...
<body>
  <!--© Maintained by @pro_morningstar-Telegram-->
    <header>
      <div class="brand">
        <img
          ...
          alt="logo"
        />
        <a href="https://t.me/pro_morningstar">
          <h2 class="name">Bittorrent Selection</h2>
        </a>
      </div>
      <div class="social">
        <a href="https://www.instagram.com/pro_morningstar"><i class="fab fa-github"></i></a>
        <a href="https://t.me/pro_morningstar"><i class="fab fa-telegram"></i></a>
      </div>
    </header>
    <div id="sticks">
    ...
    <header>
      <div class="brand">
        <img
          ...
          alt="logo"
        />
        <a href="https://t.me/Movies_Unloaded_Network">
          <h2 class="name">Bittorrent Selection</h2>
        </a>
      </div>
      <div class="social">
        <a href="https://www.instagram.com/pro_morningstar"><i class="fab fa-github"></i></a>
        <a href="https://t.me/Movies_Unloaded_Network"><i class="fab fa-telegram"></i></a>
      </div>
    </header>
    <section>
...
<body>
    <div class="header">
        <h1>Movies Unloaded Network</h1>
    </div>
    <div class="content">
        <img src="https://graph.org/file/639fe4239b78e5862b302.jpg" class="image">
        <a href="https://telegram.me/movies_unloaded_network" style="text-decoration: none;">
            <button class="button">Join Updates Channel Now</button>
        </a>
    </div>
    <div class="footer">
© 2022-23 Movies Unloaded Network. All Rights Reserved.
    </div>
</body>
</html>
"""
